...
public class OhrmAddEmpTestPOM_GRID_Node {
	LoginPage loginPage;
	OhrmBase ohrmBase;
	...
	public void openApplication(String brName, String osName, String node) {
		ohrmBase = new OhrmBase();
		loginPage = ohrmBase.openApplication(brName,osName,node);
	}
